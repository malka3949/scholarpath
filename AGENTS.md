# ScholarPath — Agent Guide

## Project

ScholarPath is an AI-powered scholarship platform for CS and Engineering students in Israel.
Architecture: modular monolith — Next.js frontend, NestJS backend, PostgreSQL as source of truth.

## Stack

| Layer | Choice |
|-------|--------|
| Frontend | Next.js (App Router), Hebrew UI |
| Backend | NestJS |
...
- AI generates content; backend persists
